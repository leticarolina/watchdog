...
type UniqueIntentHandlers<methods extends readonly Method.AnyServer[], transport extends Transport.AnyTransport> = {
    [method_name in methods[number]['intent'] as IsUniqueIntent<methods, method_name> extends true ? method_name : never]: MethodFn<Extract<methods[number], {
        intent: method_name;
...
type NestedHandlers<methods extends readonly Method.AnyServer[], transport extends Transport.AnyTransport> = {
    [name in methods[number]['name']]: {
        [mi in Extract<methods[number], {
            name: name;
        }> as mi['intent']]: MethodFn<mi, EffectiveTransportOf<mi, transport>, NonNullable<mi['defaults']>> & {
            _method: mi;
        };
    };
};
type Handlers<methods extends readonly Method.AnyServer[], transport extends Transport.AnyTransport> = {
    [mi in methods[number] as `${mi['name']}/${mi['intent']}`]: MethodFn<mi, EffectiveTransportOf<mi, transport>, NonNullable<mi['defaults']>>;
 ...
 * ```
 */
export declare function compose(...handlers: readonly ((input: Request) => Promise<MethodFn.Response<Transport.Http>>)[]): (input: Request) => Promise<MethodFn.Response<Transport.Http>>;
/**
