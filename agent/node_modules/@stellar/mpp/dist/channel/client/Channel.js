...
export function channel(parameters) {
    const { commitmentKey: commitmentKeyParam, commitmentSecret, onProgress, rpcUrl, simulationTimeoutMs = DEFAULT_SIMULATION_TIMEOUT_MS, sourceAccount, store, } = parameters;
        ...
        async createCredential({ challenge, context }) {
            ...
            if (store) {
                ...
                if (localStored && typeof localStored === 'object' && 'amount' in localStored) {
                    localPrevious = BigInt(localStored.amount);
                }
            }
            ...
            const cumulativeAmount = context?.cumulativeAmount !== undefined
            ...
            const call = contract.call('prepare_commitment', nativeToScVal(cumulativeAmount, { type: 'i128' }));
