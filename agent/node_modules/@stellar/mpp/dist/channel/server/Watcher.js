...
import { SOROBAN_RPC_URLS, STELLAR_TESTNET } from '../../constants.js';
 ...
 * ```
 */
export function watchChannel(parameters) {
    const { channel, network = STELLAR_TESTNET, rpcUrl, intervalMs = 5_000, onEvent, onError, signal, } = parameters;
...
function parseEvent(event) {
    ...
    if (!topicName || !KNOWN_TOPICS.has(topicName))
        return null;
