import { DEFAULT_POLL_MAX_ATTEMPTS, DEFAULT_POLL_DELAY_MS, DEFAULT_POLL_BACKOFF_MULTIPLIER, DEFAULT_POLL_JITTER_MS, DEFAULT_POLL_TIMEOUT_MS, } from './defaults.js';
...
export async function pollTransaction(rpcServer, hash, opts = {}) {
    const { maxAttempts = DEFAULT_POLL_MAX_ATTEMPTS, delayMs = DEFAULT_POLL_DELAY_MS, backoffMultiplier = DEFAULT_POLL_BACKOFF_MULTIPLIER, jitterMs = DEFAULT_POLL_JITTER_MS, timeoutMs = DEFAULT_POLL_TIMEOUT_MS, } = opts;
